    ...
    const validateField = function(input) {
      ...
      if (input.type === 'tel' && value !== '') {
        ...
        if (!telRegex.test(value)) {
          showError(input, input.getAttribute('data-error-tel') || 'Please enter a valid phone number');
          return false;
        }
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '259e0318-b018-4fab-bf48-a5c907c9be2c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '259e0318-b018-4fab-bf48-a5c907c9be2c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '259e0318-b018-4fab-bf48-a5c907c9be2c';
